        ...
        [
          {
            ...
            options: {
              isWholeLine: true,
              className:
                "bg-slate-400/50 dark:bg-slate-100/10 border-y-2 border-slate-500/10",
      ...
      onMount={(editor, monaco) => {
        ...
        editor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyCode.Enter, () => {
          globalThis.dispatchEvent(
            new CustomEvent("usql:command", { detail: { type: "execute" } }),
          );
        });
        ...
        editor.addCommand(
          ...
          () => {
            globalThis.dispatchEvent(
              new CustomEvent("usql:command", { detail: { type: "explain" } }),
            );
          },
        );
        ...
        editor.addCommand(
          ...
          () => {
            globalThis.dispatchEvent(
              new CustomEvent("usql:command", { detail: { type: "save-as" } }),
            );
          },
        );
        ...
        editor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyCode.KeyL, () => {
          globalThis.dispatchEvent(
            new CustomEvent("usql:command", { detail: { type: "format" } }),
          );
        });
      }}
      options={{
