        ...
        {row.getVisibleCells().map((cell, cIndex) => {
          ...
          return (
            <TableCell
              ...
              className={`data-cell select-none whitespace-nowrap font-mono text-sm max-w-[400px] border-r bg-background data-[selected=true]:bg-brand/20 dark:data-[selected=true]:bg-brand/30 ${isSelectCol ? "w-[40px] min-w-[40px] max-w-[40px] p-0" : "px-4 py-1.5 cursor-cell"}`}
              onContextMenu={(e) => {
