...
export function ColumnFilterPopover({
  ...
  const isAllSelected =
    !filterValue?.length || filterValue.length === sortedUniqueValues.length;
            ...
            {virtualizer.getVirtualItems().map((virtualItem) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground bg-muted px-1.5 py-0.5 rounded-full shrink-0 tabular-nums">
