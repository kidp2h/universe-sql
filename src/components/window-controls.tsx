  ...
  return (
    ...
    >
      ...
      {onMinimize && (
        <button
          onClick={onMinimize}
          className="group relative h-3.5 w-3.5 rounded-full bg-yellow-400 hover:bg-yellow-500 transition-colors flex items-center justify-center focus:outline-none"
        >
      ...
      {onMaximize && (
        <button
          onClick={onMaximize}
          className="group relative h-3.5 w-3.5 rounded-full bg-green-500 hover:bg-green-600 transition-colors flex items-center justify-center focus:outline-none"
        >
